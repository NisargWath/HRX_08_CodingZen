...
Create a structured **multi-week learning roadmap** for the topic: "{TOPIC}".

Requirements:
- Split the roadmap into **realistic weekly stages** (e.g., Week 1, Week 2), covering approximately **2–4 hours per week**.
- Include an overall **timestamp** in ISO format for when the roadmap was generated.
- Each week (stage) must include: 
  - Name (e.g., Week 1: Introduction)
  - Description
  - Estimated time duration for that week
  - Key concepts
  - 3 to 5 **high-quality** resources with:
    - "name" of the resource
    - full working "url"
    - "type": one of ["video", "documentation", "github", "course", "tutorial"]
    - estimated "duration" (in minutes or hours)

- At the start, include a list of **prerequisites** needed before starting the roadmap.

Response Rules:
- Respond **ONLY** with valid JSON.
- DO NOT include markdown formatting (e.g., \`\`\`), comments, or explanation text.
- All keys and string values MUST be enclosed in **double quotes**.
- Ensure all URLs are valid and working.
- Make sure the total duration across all weeks is **achievable within 3–4 weeks**.
